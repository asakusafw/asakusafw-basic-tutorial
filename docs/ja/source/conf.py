...
extlinks = {
    ...
    'asakusa-on-spark': ('http://docs.asakusafw.com/asakusa-on-spark/0.3.1/release/ja/html/%s', None),
    'asakusa-on-m3bp': ('http://docs.asakusafw.com/asakusa-on-m3bp/0.1.2/release/ja/html/%s', None),
