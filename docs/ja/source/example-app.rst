...
カテゴリ別売上金額集計バッチを簡単に説明すると、売上トランザクションデータ、商品マスタ、店舗マスタを入力として、
...
カテゴリ別売上金額集計バッチのデータフロー図を以下に示します。
...
.. _example-app-process-spec:

バッチ処理仕様
==============

カテゴリ別売上金額集計バッチの `データフロー図`_ に対応する各処理の仕様を示します。
